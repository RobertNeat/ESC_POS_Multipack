...
export type PrinterTransportKind = "usb" | "lan" | "network" | "serial" | "virtual";
...
export type PrintPayload = PrinterRawPayload | PrinterTextPayload | PrinterCommandPayload | PrinterInstructionsPayload;

export type PrinterInstruction =
  | { readonly type: "horizontalTab" }
  | { readonly type: "lineFeed" }
  | { readonly type: "realTimeDrawerPulse"; readonly pin: 2 | 5; readonly duration100ms: number }
  ...
  | { readonly type: "defineUserDefinedCharacters"; readonly firstCode: number; readonly characters: readonly UserDefinedCharacter[] }
  | { readonly type: "bitImage"; readonly mode: 0 | 1 | 32 | 33; readonly width: number; readonly data: ByteSource }
  ...
  | { readonly type: "buzzer"; readonly count: number; readonly interval100ms: number }
  ...
  | { readonly type: "justification"; readonly value: "left" | "center" | "right" }
  | { readonly type: "panelButtons"; readonly enabled: boolean }
  | { readonly type: "feedLines"; readonly lines: number }
  | { readonly type: "drawerPulse"; readonly pin: 2 | 5; readonly onTime2ms: number; readonly offTime2ms: number }
  ...
  | { readonly type: "printNvImage"; readonly image: number; readonly mode: ImageScale }
  | { readonly type: "defineNvImages"; readonly images: readonly NvImage[] }
  | { readonly type: "characterSize"; readonly width: Scale1To8; readonly height: Scale1To8 }
  | { readonly type: "reverse"; readonly enabled: boolean }
  | { readonly type: "hriPosition"; readonly position: "none" | "above" | "below" | "both" }
  ...
  | { readonly type: "barcode"; readonly system: BarcodeSystem; readonly data: ByteSource; readonly format?: "lengthPrefixed" | "nulTerminated" }
  | { readonly type: "rasterImage"; readonly mode: ImageScale; readonly widthBytes: number; readonly height: number; readonly data: ByteSource }
  ...
  | { readonly type: "hanziSpacing"; readonly left: number; readonly right: number }
  | { readonly type: "qrCode"; readonly version: number; readonly errorCorrection: "L" | "M" | "Q" | "H"; readonly moduleSize: number; readonly data: ByteSource }
...
export type ImageScale = "normal" | "doubleWidth" | "doubleHeight" | "quadruple";
export type Scale1To8 = 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8;
export type BarcodeSystem = "upcA" | "upcE" | "ean13" | "ean8" | "code39" | "itf" | "codabar" | "code93" | "code128";
...
export type PrinterOperationName =
  ...
  | "setAlignment" | "setTextStyle" | "feed" | "cut" | "openCashDrawer"
  | "configure" | "getStatus" | "printSelfTest" | "printCodePageTable" | "restoreFactorySettings";
